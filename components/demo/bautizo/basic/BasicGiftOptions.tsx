      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {basicDemoData.gifts.options.map((option, index) => (
            <div 
              key={index}
              className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200 hover:shadow-lg transition-all duration-300"
            >
              {/* Icono */}
              <div className="flex justify-center mb-4">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p className="text-sm text-blue-800 text-center">
            <strong>💡 Demo:</strong> Esta información es de ejemplo. En tu invitación real, 
            se personalizará con los datos específicos del bautizo de {basicDemoData.hero.name}.
          </p>
        </div>
      </div>
    </section>
